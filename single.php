     ...
     <div class="page-wrapper">
          ...
          <div class="content clearfix">
               ...
               <div class="sidebar single">
                    ...
                    <div class="section popular" id="single-posts-container">
                         ...
                         ?>
                              <div class="post clearfix">
                                   <a href="single.php?t_id=<?php echo $post['topic_id']; ?>&p_id=<?php echo $post['id']; ?>&title=<?php echo $post['title']; ?>"><img src="<?php echo BASE_URL . '/assets/images/' . $post['image'] ?>" alt=""></a>
                                   <a href="single.php?t_id=<?php echo $post['topic_id']; ?>&p_id=<?php echo $post['id']; ?>&title=<?php echo $post['title']; ?>" class="title"><p class="p-title">
                         ...
                         <div class="pagination-links">
                              ...
                              <?php if ($recents['prevPage']): ?>
                                   <a class = "side-page-btn" href="single.php?t_id=<?php echo $_GET['t_id']; ?>&p_id=<?php echo $_GET['p_id']; ?>&title=<?php echo $_GET['title']; ?>&page=<?php echo $recents['prevPage']; ?>#single-posts-container">< Prev</a><?php if(isset($_GET['page'])): ?> <span class="page-num">-  Page <?php echo $_GET['page']?>  -</span> <?php endif;?>
                              <?php else: ?>
                              ...
                              <?php if ($recents['nextPage']): ?>
                                   <a class = "side-page-btn" href="single.php?t_id=<?php echo $_GET['t_id']; ?>&p_id=<?php echo $_GET['p_id']; ?>&title=<?php echo $_GET['title']; ?>&page=<?php echo $recents['nextPage']; ?>#single-posts-container">Next ></a>
                              <?php else: ?>
                    ...
                    <div class="section topics sidebar-sticky">
