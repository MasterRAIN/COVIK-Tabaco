...
<head>
     ...
     <title>Admin Section - User Request Details</title>
     ...
     <body class="admin-body">
          ...
          <div class="admin-wrapper">
               ...
               <div class="admin-content">
                    ...
                    <div class="content">
                         <h2 class="page-title">User Request Details</h2>
                         ...
                         <form action="requestDetails.php" method="post">
                              ...
                              <div>
                                   <input type="hidden" name="password" value="<?php echo $password; ?>" class="text-input admin-input">
                              </div>
                              <div>
                                   <input type="hidden" name="passwordConf" value="<?php echo $password; ?>" class="text-input admin-input">
                              </div>

                              <div>
                                   <button type="submit" name="register-btn" class="btn btn-big">Approve</button>
                              </div>
                              
                         </form>

                         <a href="requests.php?delete_id=<?php echo $_GET['request_id']; ?>" class="btn" id="decline">Decline</a>
                    </div>
               </div>
               <!--ADMIN CONTENT//-->
